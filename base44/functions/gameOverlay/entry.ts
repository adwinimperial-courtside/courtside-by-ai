...
<script type="module" src="${url.origin}/api/functions/gameOverlayScript?gameId=${gameId}&appId=${appId}&serverUrl=${encodeURIComponent(serverUrl)}&rawTime=${encodeURIComponent(String(d.timeLeft || '0'))}"></script>
</body>
</html>`;
