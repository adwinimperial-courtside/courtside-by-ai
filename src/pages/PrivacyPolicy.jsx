      ...
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="prose prose-slate max-w-none text-sm text-slate-700 space-y-6">
          ...
          <section>
            ...
            <p className="mt-2">If a photo is uploaded, it may be displayed inside Courtside by AI as part of your player profile, league profile, game results, awards, or related league features.</p>
            <p className="mt-2">League organizers are responsible for making sure they have the player's permission before uploading a photo of them, and before publishing player photos or player-related content outside Courtside by AI, including on social media. For players under 18, a parent or guardian's permission is required before a photo is uploaded.</p>
