...
3. This league does not record shot attempts. NEVER mention field goal percentage, three-point percentage, free throw percentage, shooting efficiency or any percentage statistic. Talk in makes and volume instead. Every three-point figure you are given is threes MADE BY THAT TEAM. Threes attempted and threes conceded are not recorded anywhere in this app and do not exist. Never write that a team "put up", "took", "attempted", "gave up", "allowed" or "conceded" a number of threes — write that they MADE them. A team's own three-point number can never be described as something their defence let in.
